...
public class RoomShareLandlord extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_room_share_landlord);

        add = findViewById(R.id.addRoom);
        mButton = findViewById(R.id.img);
        et1 = findViewById(R.id.priceRoom);
        et2 = findViewById(R.id.locationRoom);
        et3 = findViewById(R.id.typeRoom);
        et4 = findViewById(R.id.detailsRoom);
        ...
        dbRef=mDb.getReference().child("RoomShare");
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!(loc.isEmpty() && price.isEmpty() && type.isEmpty() && details.isEmpty() && imageUrl!=null)){
                    ...
                    StorageReference filepath = mStorage.getReference().child("imageRoomShare").child(imageUrl.getLastPathSegment());
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Task<Uri> downloadUrl = taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    Intent intent = new Intent(RoomShareLandlord.this,LandActivity.class);
